/* ==========================================================================
   PEGASUS OS - MASTER MANIFEST & REGISTRY (v18.93)
...
window.PegasusManifest = {
    ...
    metadata: {
        ...
        engine_version: "v18.93 per-exercise set progress guard"
    },
...
console.log("🏛️ PEGASUS MANIFEST v18.93 LOADED. PER-EXERCISE SET GUARD READY.");
