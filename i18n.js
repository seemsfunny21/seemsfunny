...
(function() {
    ...
    const exactPairs = [
        ...
        ['💾 Αποθήκευση αρχείου', '💾 SAVE FILE'], ['📂 Φόρτωση αρχείου', '📂 LOAD FILE'], ['💾 Τοπικά δεδομένα', '💾 LOCAL DATA'],
        ...
        ['Τοπική λειτουργία', 'LOCAL MODE'], ['Σφάλμα', 'ERROR'], ['Λάθος PIN', 'WRONG PIN'], ['Αερόβια', 'Cardio'],
    ...
    const extraExactPairs = [
        ...
        ['Αποθήκευση αρχείου', 'Save file'], ['Φόρτωση αρχείου', 'Load file'], ['Τοπική λειτουργία', 'Local mode'],
    ...
    const phrasePairs = [
        ...
        ['Ήχος:', 'SOUND:'], ['Τύπος προγράμματος', 'PROGRAM TYPE'], ['Τοπική λειτουργία', 'LOCAL MODE'],
