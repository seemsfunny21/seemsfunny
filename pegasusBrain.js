/* ========================================================================== 
   PEGASUS BRAIN - v1.0.302 (LOCAL-ONLY + NEXT EXERCISE PREVIEW + CLASSIC 40-MIN SPLIT)
...
(function installPegasusBrain() {
    ...
    console.log("🧠 PEGASUS BRAIN: MS-600 planner active (v1.0.302, local-only + activity calendar + next exercise preview + classic 40-min split).");
})();
